...
function threepaymobil_link($params) {
	...
	$return = "";
	$input = array('MPAY' => "VPSCenter-".$params['invoiceid'], 'Content' => $params['description'],'SendOrderResult' => 'true', 'PaymentTypeId' => '1', 'ReceivedSMSObjectId' => '00000000-0000-0000-0000-000000000000', 'ProductList' => array('MSaleProduct' => array('ProductId' => '0', 'ProductCategory' => $params['ProductCategory'], 'ProductDescription' => $params['description'], 'Price' => $Amount, 'Unit' => '1')), 'SendNotificationSMS' => 'True', 'OnSuccessfulSMS' => 'Odeme basariyla tamamlandi.', 'OnErrorSMS' => 'Odeme tamamlanirken hata olustu.', 'RequestGsmOperator' => $RequestGsmOperator, 'RequestGsmType' => '0', 'Url' => $_SERVER['HTTP_HOST'], 'SuccessfulPageUrl' => $SuccessfulPageUrl, 'ErrorPageUrl' => $ErrorPageUrl, 'Country' => '', 'Currency' => '', 'Extra' => $Extra, 'TurkcellServiceId' => $params['TurkcellServiceId']);
